"""
Integration seam for the Analysis Orchestration module.

Only Audit Logging doesn't exist yet - same Protocol + in-memory-stub
pattern as every module so far. This module has no other dependency: it
doesn't need branch/timezone/contract context, and it doesn't call any
other module's business logic (see package docstring for why).
"""
